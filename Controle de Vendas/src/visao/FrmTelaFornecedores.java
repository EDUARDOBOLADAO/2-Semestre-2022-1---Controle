 ...
 */
public class FrmTelaFornecedores extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jTblFornecedores.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Código", "Nome", "CNPJ", "E-mail", "Telefone", "Celular", "CEP", "Endereço", "Nº", "Comp11", "Bairro", "Cidade", "UF"
            }
        ));
        ...
        JtbPaneDadosPessoais.addTab("Consulta de Fornecedores", jPanel3);

        jBtnNovo.setFont(new java.awt.Font("Aharoni", 1, 14)); // NOI18N
        ...
        jBtnSalvar.setFont(new java.awt.Font("Aharoni", 1, 14)); // NOI18N
        ...
        jBtnEditar.setFont(new java.awt.Font("Aharoni", 1, 14)); // NOI18N
        ...
        jBtnExcluir.setFont(new java.awt.Font("Aharoni", 1, 14)); // NOI18N
    ...
    private void jTblFornecedoresMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTblFornecedoresMouseClicked
        ...
        jTxtCodigo1.setText(jTblFornecedores.getValueAt(jTblFornecedores.getSelectedRow(), 0).toString());
        jTxtNome.setText(jTblFornecedores.getValueAt(jTblFornecedores.getSelectedRow(), 1).toString());
        jTxtCNPJ.setText(jTblFornecedores.getValueAt(jTblFornecedores.getSelectedRow(), 2).toString());
        jTxtEmail.setText(jTblFornecedores.getValueAt(jTblFornecedores.getSelectedRow(), 3).toString());
        jTxtTelefone.setText(jTblFornecedores.getValueAt(jTblFornecedores.getSelectedRow(), 4).toString());
        jTxtCelular.setText(jTblFornecedores.getValueAt(jTblFornecedores.getSelectedRow(), 5).toString());
        jTxtCep.setText(jTblFornecedores.getValueAt(jTblFornecedores.getSelectedRow(), 6).toString());
        jTxtEndereco.setText(jTblFornecedores.getValueAt(jTblFornecedores.getSelectedRow(), 7).toString());
        jTxtNumero.setText(jTblFornecedores.getValueAt(jTblFornecedores.getSelectedRow(), 8).toString());
        jTxtComplemento.setText(jTblFornecedores.getValueAt(jTblFornecedores.getSelectedRow(), 9).toString());
        jTxtBairro.setText(jTblFornecedores.getValueAt(jTblFornecedores.getSelectedRow(), 10).toString());
        jTxtCidade.setText(jTblFornecedores.getValueAt(jTblFornecedores.getSelectedRow(), 11).toString());
        jCBXUF.setSelectedItem(jTblFornecedores.getValueAt(jTblFornecedores.getSelectedRow(), 12).toString());
...
//Exibi os dados do obj nos campos de texto
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrmTelaFornecedores.class
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FrmTelaFornecedores().setVisible(true);
            }
        });
    }
